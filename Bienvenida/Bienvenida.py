...
@client.on_member_join_chat(https://aminoapps.com/c/anime-es/page/chat-thread/el-rincon-de-cebollin-anime/Z6xT_DsgMJBvJRZGY3G8JVVXkB80WEv) #Bienvenida a un nuevo usuario, evento.
def bienvenida(data):
...
@client.on_member_leave_chat(https://aminoapps.com/c/anime-es/page/chat-thread/el-rincon-de-cebollin-anime/Z6xT_DsgMJBvJRZGY3G8JVVXkB80WEv) #Hacemos una simple despedida de Chat.
def despedida(data):
